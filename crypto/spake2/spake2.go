...
import (
	ciphersuite2 "github.com/galenliu/chip/crypto/spake2/internal/ciphersuite"
)
...
type SPAKE2 struct {
	suite ciphersuite2.CipherSuite
}
...
func Scrypt(N, R, P int) *ciphersuite2.Scrypt {
	return &ciphersuite2.Scrypt{N, R, P}
}

// Ed25519Sha256HkdfHmacScrypt returns a cipher suite for SPAKE2 (or SPAKE2+).
func Ed25519Sha256HkdfHmacScrypt(scrypt *ciphersuite2.Scrypt) *ciphersuite2.Ed25519Sha256HkdfHmacScrypt {
	return &ciphersuite2.Ed25519Sha256HkdfHmacScrypt{
		Scrypt: scrypt,
	}
}

// NewSPAKE2 creates a new instance of SPAKE2.
func NewSPAKE2(suite ciphersuite2.CipherSuite) (*SPAKE2, error) {
	return &SPAKE2{suite}, nil
}

// NewSPAKE2Plus creates a new instance of SPAKE2+.
func NewSPAKE2Plus(suite ciphersuite2.CipherSuite) (*SPAKE2Plus, error) {
	return &SPAKE2Plus{suite}, nil
}

func (s SPAKE2) startClient(clientIdentity, serverIdentity, password, salt, aad []byte, x ciphersuite2.Scalar) (*ClientState, []byte, error) {
...
func (s SPAKE2) startServer(clientIdentity, serverIdentity, verifier, aad []byte, y ciphersuite2.Scalar) (*ServerState, []byte, error) {
...
func (s SPAKE2) computeW(password, salt []byte) (ciphersuite2.Scalar, error) {
...
func (s SPAKE2Plus) startClient(clientIdentity, serverIdentity, password, salt, aad []byte, x ciphersuite2.Scalar) (*ClientPlusState, []byte, error) {
...
func (s SPAKE2Plus) startServer(clientIdentity, serverIdentity, verifierW0, verifierL, aad []byte, y ciphersuite2.Scalar) (*ServerPlusState, []byte, error) {

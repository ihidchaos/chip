...
//	config.SetEnvVars(&env, "CHIP_ENVIRONMENT", cfg.GetString("environment"))
//	config.SetEnvVars(&env, "CHIP_ENV", cfg.GetString("environment"))
//
//	if fs != nil {
//		fis, err := afero.ReadDir(fs, files.FolderJSConfig)
//		if err == nil {
//			for _, fi := range fis {
//				key := fmt.Sprintf("CHIP_FILE_%s", strings.ReplaceAll(strings.ToUpper(fi.Name()), ".", "_"))
